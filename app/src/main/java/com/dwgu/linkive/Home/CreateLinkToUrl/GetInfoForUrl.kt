...
public fun GetInfoForUrl(url: String, folder: String?): LinkListData {
    var ogMap: HashMap<String, String> = hashMapOf()

    // 페이지에서 가져온 데이터 정리
    lateinit var linkData: LinkListData
    ...
    CoroutineScope(Dispatchers.IO).launch {
        ...
        elements?.let {
            ...
            try {
                ...
                linkData = LinkListData(linkUrl, title, folderName, thumbnailImage, linkItemSource)
