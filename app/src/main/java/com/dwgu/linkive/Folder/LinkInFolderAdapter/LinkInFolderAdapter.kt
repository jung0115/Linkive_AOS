package com.dwgu.linkive.Folder.LinkInFolderAdapter
...
class LinkInFolderAdapter (private val context: Context,
val onClickLinkItem: () -> Unit
) :
RecyclerView.Adapter<LinkInFolderAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) :
        ...
        return ViewHolder(ItemLinkOfListBinding.bind(view))
    }
    ...
    inner class ViewHolder(private val binding: ItemLinkOfListBinding) :
